<script lang="ts">
	...
	import Editor from '../../../../(role:user)/editor/anthologies/editor.svelte';
	import { schemaOfAttachments } from '../../../../(role:user)/editor/anthologies/schemas';
...
<div class="mx-auto w-full max-w-xl">
	<Header>
		<h1 class="overflow-hidden text-sm whitespace-nowrap">All anthologies</h1>
	</Header>
</div>

...
export type ClientAuthenticationMethod =
	(typeof ClientAuthenticationMethod)[keyof typeof ClientAuthenticationMethod];
...
type ClientApiKey = {
	...
	secret: string;
	scopes: string[];
	lastUsedAt: ColumnType<Date | null, Date | null, Date | null>;
	createdAt: ColumnType<Date, never, never>;
	createdBy: string | null;
	updatedAt: ColumnType<Date, never, Date>;
	updatedBy: string | null;
...
type User = {
	...
	phoneConfirmed: ColumnType<boolean, boolean | null, boolean>;

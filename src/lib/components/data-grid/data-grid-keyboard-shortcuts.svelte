...
<Dialog {open} {onOpenChange}>
	<DialogContent class="max-w-2xl px-0 pb-0" {onOpenAutoFocus} showCloseButton={false}>
		...
		<div class="px-6">
			<div class="relative">
				<Search class="absolute top-1/2 left-3 size-3.5 -translate-y-1/2 text-muted-foreground" />
				<Input
					bind:ref={inputRef}
		...
		<div class="h-[40vh] overflow-y-auto px-6 pb-6">

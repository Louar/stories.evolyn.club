<script lang="ts" module>
	...
	import type { GeoJSONSource, LineLayerSpecification, MapMouseEvent } from 'maplibre-gl';
...
<script lang="ts" generics="T extends MapArcDatum = MapArcDatum">
	...
	const DEFAULT_PAINT: NonNullable<LineLayerSpecification['paint']> = {
		'line-color': '#4285F4',
		'line-width': 2,
		'line-opacity': 0.85
	};

	const DEFAULT_LAYOUT: NonNullable<LineLayerSpecification['layout']> = {
		'line-join': 'round',
		'line-cap': 'round'
	};
	...
	function mergeArcPaint(
		base: NonNullable<LineLayerSpecification['paint']>,
		hover: NonNullable<LineLayerSpecification['paint']> | undefined
		...
		return merged as NonNullable<LineLayerSpecification['paint']>;
	}
